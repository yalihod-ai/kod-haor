...
var tiles = [
  ...
  {ic:'📚', title:'ספריית התוכן', desc:'הידע המלא — שמנים, חמאות, חומרי גלם ושגרת טיפוח. לגלישה חופשית.', href:'https://yalihodschool.co.il/kod-haor-library/', need:'library'},
  {ic:'🧪', title:'בנק המתכונים', desc:'28 מתכונים נוספים מהספר.', href:'https://yalihodschool.co.il/kod-haor-recipes/', need:'recipes'},
...
var _own=[]; try{ if(window.KH && window.KH.products) _own=window.KH.products; }catch(e){}
tiles.forEach(function(t){
  if(t.need && _own.indexOf(t.need)===-1){
    t.locked=true; t.href=null; t.lockText='🔒 זמין בשדרוג';
  }
});
